...
export const insertar = [
  ...
  check('id_tramite')
    .exists()
    .withMessage('El ID del trámite es requerido')
    .isUUID()
  ...
  check('tipo')
    ...
    .trim()
    .isLength({ min: 5 })
    .withMessage('El tipo de pago debe tener al menos 5 caracteres'),
  ...
  check('detalle')
    ...
    .trim()
    .isLength({ min: 5 })
    .withMessage('El detalle debe tener al menos 5 caracteres'),
  ...
  check('created_at')
    ...
    .isISO8601()
    .withMessage('Fecha de creación inválida'),
...
export const actualizar = [
  ...
  check('id_tramite')
    .optional()
    .isUUID()
    .withMessage('ID de trámite no válido'),
  ...
  check('detalle')
    ...
    .trim()
    .isLength({ min: 5 })
    .withMessage('El detalle debe tener mínimo 5 caracteres'),
  ...
  check('updated_at')
    ...
    .isISO8601()
    .withMessage('Fecha de actualización inválida'),
